...
<div class="container" style="margin-top: 80px">
    <div class="row justify-content-center">
        @if(Session('error')) <div class="alert alert-danger">
            <span class="glyphicon glyphicon-alert"></span> {{Session('error')}}
        </div> @endif
        <div class="col-md-6">
            <div class="card">
                    ...
                    <form method="POST" action="{{ route('signin') }}">
                        ...
                        <div class="form-group row" style="margin-right: 0px">
                            <label for="email" class="col-md-4 col-form-label text-md-right" style="">
                                <i class="fa fa-envelope-open-o fa-2x text-success" style="font-size: 20px"></i></label>
                        ...
                        <div class="form-group row" style="margin-right: 0px">
                            <label for="password" class="col-md-4 col-form-label text-md-right"><i class="fa fa-lock fa-2x text-success" ></i></label>
